...
echo "        ", str_repeat( ' ', $maxLen - 3 ), "        Inclusive        Own\n";
echo "function", str_repeat( ' ', $maxLen - 3 ), "#calls  time     memory  time     memory\n";
echo "--------", str_repeat( '-', $maxLen - 3 ), "----------------------------------------\n";
...
foreach( $functions as $name => $f )
{
	...
	printf( "%-{$maxLen}s %10d  %3.4f %8d  %3.4f %8d\n",
		$name, $f['calls'],
